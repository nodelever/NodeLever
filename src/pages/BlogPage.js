...
export default function SolutionsPage() {
  ...
  const solutions = [
    {
      id: 'data-annotation',
      icon: MessageCircle,
      title: 'RLHF & Data Annotation',
      subtitle: 'Train the foundational models',
      description: 'Provide high-quality human feedback to refine AI responses. Perfect for writers, educators, and detail-oriented professionals shaping the next generation of LLMs.',
      features: [
        'Prompt generation and response ranking',
        'Fact-checking and hallucination detection',
        'Tone, style, and safety alignment',
        'Flexible, high-volume task streams'
      ],
      color: 'from-purple-600 to-pink-600',
      bgColor: 'from-purple-900/20 to-pink-900/20',
      accent: 'purple-400'
    },
    {
      ...
      description: 'Review, debug, and optimize code generated by AI. Help models understand complex logic across multiple programming languages and frameworks.',
      features: [
        'Code debugging and refactoring tasks',
        'Algorithm optimization review',
        'Support for JS, Node, React Native, and more',
        'Premium payout rates for senior devs'
      ],
      color: 'from-cyan-600 to-blue-600',
      bgColor: 'from-cyan-900/20 to-blue-900/20',
      accent: 'cyan-400'
    },
    {
      id: 'domain-expert',
      icon: Award,
      title: 'Domain Expert Verification',
      subtitle: 'Specialized knowledge tracks',
      description: 'Leverage your advanced degrees and professional experience to train specialized AI models in medicine, law, finance, and the hard sciences.',
      features: [
        'Advanced scientific reasoning checks',
        'Legal and financial accuracy validation',
        'Peer-reviewed credentialing system',
        'Highest compensation tier available'
      ],
      color: 'from-green-600 to-teal-600',
      bgColor: 'from-green-900/20 to-teal-900/20',
      accent: 'green-400'
    },
    {
      ...
      subtitle: 'Security and safety testing',
      description: 'Stress-test AI models by intentionally trying to bypass safety filters. Help build robust, secure, and ethical AI systems before they deploy.',
      features: [
        'Adversarial prompt engineering',
        'Bias and toxicity detection',
        'Security vulnerability probing',
        'Exclusive bounty-based rewards'
      ],
      color: 'from-pink-600 to-red-600',
      bgColor: 'from-pink-900/20 to-red-900/20',
      accent: 'pink-400'
  ...
  const features = [
    {
      ...
      description: 'Our algorithm pairs you with evaluation tasks perfectly suited to your specific technical skills and background.',
      color: 'text-purple-400'
    },
    {
      icon: Clock,
      title: 'Flexible Schedule',
      description: 'Work asynchronously. Pick up coding or annotation tasks anytime, anywhere, on your own terms.',
      color: 'text-cyan-400'
    },
    {
      icon: Zap,
      title: 'Verified Payouts',
      description: 'Secure, automated payments released quickly upon task validation and quality assurance checks.',
      color: 'text-green-400'
    },
    {
      icon: Brain,
      title: 'Skill Progression',
      description: 'Unlock higher-paying enterprise tiers as your accuracy, throughput, and node rating improve.',
      color: 'text-pink-400'
    },
    {
      icon: Layers,
      title: 'Domain Variety',
      description: 'From React layout debugging to creative writing and complex legal document review.',
      color: 'text-yellow-400'
    },
    {
      icon: Globe,
      title: 'Expert Community',
      description: 'Join a global network of top-tier professionals actively shaping the future of artificial intelligence.',
      color: 'text-blue-400'
    }
  ];
  ...
  const testimonials = [
    {
      name: 'Sarah Jenkins',
      location: 'Remote',
      feedback: 'I transition from writing code all day to evaluating AI-generated React components in the evening. The interface is seamless, and the payouts are highly competitive.',
      rating: 5,
      avatar: '👩‍💻',
      company: 'Senior Frontend Dev'
    },
    {
      name: 'Dr. Marcus Webb',
      location: 'Boston, MA',
      feedback: 'As a medical professional, I appreciate that they value specialized domain knowledge. Reviewing biomedical AI outputs here has been both lucrative and intellectually engaging.',
      rating: 5,
      avatar: '🔬',
      company: 'Domain Expert Panel'
    },
    {
      name: 'Elena Rostova',
      location: 'Berlin, DE',
      feedback: 'The red-teaming track is incredible. Finding edge cases in language models is essentially a paid puzzle game. The tiered reward system keeps me constantly motivated.',
      rating: 5,
      avatar: '🎯',
      company: 'AI Safety Specialist'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-50 overflow-hidden">
      ...
      <section 
        ref={el => sectionRefs.current.hero = el}
        className="relative pt-32 pb-16 flex items-center justify-center"
      >
        {/* Background Effects */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <FloatingElement delay={300}>
            <p className="text-xl md:text-2xl text-slate-400 mb-12 max-w-4xl mx-auto leading-relaxed">
              Discover our comprehensive suite of <span className="text-purple-400 font-semibold">AI training roles</span> designed 
              to upskill you while you actively shape the next generation of intelligent models.
            </p>
          </FloatingElement>
        </div>
      </section>
      ...
      <section className="py-20 relative bg-[#0b1121]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Why Train <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">With Us</span>
            </h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              Built for modern tech professionals looking for flexible, high-leverage ways to monetize their expertise.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group">
                <div className="bg-slate-800/40 backdrop-blur-lg rounded-3xl p-8 border border-slate-700/50 hover:border-slate-600 transition-all duration-300 h-full hover:scale-105">
                  <div className="mb-6 flex justify-center">
                    <div className="p-4 rounded-full bg-slate-900/50 backdrop-blur-lg border border-slate-700/50 group-hover:scale-110 transition-transform duration-300">
                      <feature.icon className={`w-8 h-8 ${feature.color}`} />
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-white mb-4 text-center">{feature.title}</h3>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Active <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Roles</span>
            </h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              From general language alignment to deep technical debugging, find the track that fits your background.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (
              <div 
                ...
                onMouseLeave={() => setHoveredSolution(null)}
              >
                <div className={`bg-gradient-to-br ${solution.bgColor} backdrop-blur-lg rounded-3xl p-8 border border-slate-700/50 hover:border-slate-600 transition-all duration-500 h-full`}>
                  <div className="flex items-start gap-6 mb-6">
                    <div className={`p-4 rounded-2xl bg-gradient-to-br ${solution.color} group-hover:scale-110 transition-transform duration-300`}>
                      <solution.icon className="w-8 h-8 text-white" />
                    </div>
                  ...
                  <div className="flex gap-4">
                    <Link to="/about" className="w-full">
                      <button className={`w-full flex justify-center gap-4 bg-gradient-to-r ${solution.color} px-6 py-3 rounded-full text-white font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg`}>
                        Apply to Track
                      </button>
                    </Link>
                  </div>
      ...
      <section className="py-20 relative bg-[#0b1121]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              From Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Trainers</span>
            </h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">
              See how our experts are leveling up their skills while getting paid to evaluate AI.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="group">
                <div className="bg-slate-800/40 backdrop-blur-lg rounded-3xl p-8 border border-slate-700/50 hover:border-purple-400/50 transition-all duration-300 h-full hover:scale-105 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={i} className="w-5 h-5 text-yellow-400 fill-current" />
      ...
      <section className="py-20 relative">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-gradient-to-br from-purple-900/30 to-cyan-900/30 backdrop-blur-lg rounded-3xl p-12 border border-slate-700/50">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Get Paid</span>?
            </h2>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Join the network today. Pass the initial skills assessment to unlock your first training tasks.
            </p>
